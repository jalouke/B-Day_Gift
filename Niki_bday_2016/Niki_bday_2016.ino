...
Adafruit_NeoPixel strip = Adafruit_NeoPixel(CLOCK_PIXELS, STRIP_PIN, NEO_RGB + NEO_KHZ800);
...
void setup() 
{
  ...
  if (! rtc.isrunning()) 
  {
    rtc.adjust(DateTime(F(__DATE__), F(__TIME__)));//F(__DATE__), F(__TIME__)
